  ...
  return (
    <footer id="contact" className="bg-dark-card border-t border-dark-border">
      <div className="wrap pt-16 pb-8">
        <div className="grid gap-10 md:grid-cols-6 lg:grid-cols-6">
          {/* Brand */}
            ...
            <div className="mt-6 flex gap-3">
              {SOCIALS.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-9 h-9 rounded-lg border border-dark-border bg-dark-muted text-text-tertiary flex items-center justify-center hover:text-white hover:border-accent/30 transition-all duration-200"
                >
                  {s.icon}
                </a>
              ))}
        ...
        <div className="mt-14 flex flex-col gap-3 border-t border-dark-border pt-6 text-sm text-text-tertiary sm:flex-row sm:items-center sm:justify-between">

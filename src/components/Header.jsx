...
export default function Header() {
  ...
  return (
    ...
    <header className="sticky top-0 z-50 bg-ink shadow-header [&_:focus-visible]:ring-offset-ink">
      ...
      <div className="wrap flex items-center justify-between gap-6 py-3">
        <Link to="/" aria-label="MJAMV, home" className="shrink-0">
          <Logo height={44} subColor="#F3EFE6" className="h-11 w-auto" />
        </Link>
        ...
        <nav className="hidden items-center gap-1 lg:flex" aria-label="Main">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {servicesOpen && (
              <div className="absolute left-0 top-full z-50 mt-2 w-72 rounded-xl border border-white/10 bg-ink p-2 shadow-card-hover">

...
import exhaustPhoto from '../../assets/images/services offered.jpg';
      ...
      <section className="border-b border-paper-line bg-paper-alt">
        <div className="wrap py-12 sm:py-16">
          <nav aria-label="Breadcrumb" className="text-[0.875rem] text-ink-faint">
            <Link to="/" className="hover:text-crimson-light">
              Home
            </Link>
            <span className="mx-2">/</span>
            <Link to="/#services" className="hover:text-crimson-light">
              Services
            </Link>
            <span className="mx-2">/</span>
          ...
          <div className="mt-8 grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            <div>
              <span className="flex h-14 w-14 items-center justify-center rounded-full bg-crimson-tint text-crimson-light">
            ...
            {service.slug === 'kitchen-exhaust-cleaning' ? (
              <img
                src={exhaustPhoto}
                alt="Cleaning a kitchen exhaust filter with a microfiber cloth"
                width={2048}
                height={1365}
                className="block aspect-[4/3] w-full rounded-xl border border-paper-line object-cover shadow-card"
              />
            ) : (
            <div className="flex aspect-[4/3] flex-col items-center justify-center gap-3 rounded-xl border border-paper-line bg-surface shadow-card">
        ...
        <div className="wrap">
          ...
          <Reveal delay={200} className="mt-8 text-center">
            <p className="text-[0.9375rem] text-ink-soft">
              ...
              <Link to="/#contact" className="font-medium text-crimson-light hover:text-ink">
                Contact us
              </Link>
              .
            </p>
          ...
          <div className="mx-auto mt-10 grid max-w-4xl gap-6 md:grid-cols-2">
            {others.map((other, i) => (
              <Reveal key={other.slug} delay={i * 100}>
                ...
                >
                  <span className="h-11 w-11 text-crimson-light">
                  ...
                  <span className="mt-4 inline-flex items-center gap-1.5 text-[0.9375rem] font-medium text-crimson-light">
                    Learn More

    ...
    <section id="contact" className="section border-t border-paper-line bg-paper-alt">
      <div className="wrap grid gap-10 lg:grid-cols-5 lg:gap-14">
        <Reveal className="lg:col-span-2">
          ...
          <a
            href="tel:+639001234567"
            className="mt-6 inline-block text-2xl font-bold text-crimson-light hover:text-ink"
          >
            +63 900 123 4567
          </a>
          ...
          <div className="mt-8 space-y-4">
            {DETAILS.map((d) => (
              <a key={d.label} href={d.href} className="group flex items-center gap-4">
                <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-crimson-tint text-crimson-light">
                ...
                <span>
                  ...
                  <span className="block font-medium text-ink group-hover:text-crimson-light">
                    {d.value}
                  </span>
                </span>
              </a>
        ...
        <Reveal delay={120} className="lg:col-span-3">
          <form onSubmit={handleSubmit} className="palette-light card relative p-7 sm:p-8">
            <Honeypot />

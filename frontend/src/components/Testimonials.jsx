...
function Stars() {
  return (
    <span className="flex gap-0.5 text-crimson-light" aria-label="5 out of 5">
      {[0, 1, 2, 3, 4].map((i) => (
    ...
    <section id="testimonials" className="section">
      <div className="wrap">
        ...
        <Reveal className="mt-4 flex justify-center">
          ...
          <span className="rounded-full border border-paper-line bg-surface px-3 py-1 text-[0.75rem] font-bold uppercase tracking-wide text-ink-soft">
